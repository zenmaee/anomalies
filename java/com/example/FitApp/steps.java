...
public class steps extends Activity implements SensorEventListener, step_listening {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        start.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                number_of_steps = 0;
                sensorManager.registerListener(steps.this,accelerometer,SensorManager.SENSOR_DELAY_FASTEST);
            }
        });
